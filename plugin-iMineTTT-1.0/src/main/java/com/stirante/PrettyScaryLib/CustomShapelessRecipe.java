...
public class CustomShapelessRecipe extends ShapelessRecipes implements IRecipe {
	...
	public ItemStack a(InventoryCrafting arg0) {
		...
		org.bukkit.inventory.ItemStack[] inventory = new org.bukkit.craftbukkit.inventory.CraftItemStack[arg0.getSize()];
		for (int i = 0; i < arg0.getContents().length; i++) {
			inventory[i] = new org.bukkit.craftbukkit.inventory.CraftItemStack(arg0.getContents()[i]);
		}
