...
public class CustomShapedRecipe extends ShapedRecipes implements IRecipe{
	...
	public ItemStack a(InventoryCrafting inv) {
		...
		org.bukkit.inventory.ItemStack[] inventory = new org.bukkit.craftbukkit.inventory.CraftItemStack[inv.getSize()];
		for (int i = 0; i < inv.getContents().length; i++) {
			inventory[i] = new org.bukkit.craftbukkit.inventory.CraftItemStack(inv.getContents()[i]);
		}
